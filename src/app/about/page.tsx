    ...
    <>
      ...
      <section className="bg-white py-20">
        <Container className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <Reveal delay={120} className="space-y-5 text-ink-700/75">
      ...
      <section className="bg-ink-950 py-16">
        <Container>
          <div className="grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-white/10 bg-white/5 lg:grid-cols-4">
            {stats.map((s, i) => (
              <Reveal key={s.label} delay={i * 80} className="bg-ink-900/40 px-6 py-8 text-center">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <Reveal key={c.title} delay={i * 90}>
                <div className="card-premium h-full rounded-2xl bg-white p-7">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {processSteps.map((step, i) => (
              <Reveal key={step.n} delay={i * 90}>
                <div className="card-premium h-full rounded-2xl bg-cream-50 p-6">
